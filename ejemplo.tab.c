...
#line 1219 "ejemplo.tab.c"
    break;

  case 7: /* line: FIN_FICHEIRO  */
#line 91 "ejemplo.y"
                       {printf(">> ");}
#line 1225 "ejemplo.tab.c"
    break;

  case 8: /* line: error  */
#line 92 "ejemplo.y"
                {yyclearin;}
#line 1231 "ejemplo.tab.c"
    break;

  case 9: /* exp: NUMERO  */
#line 95 "ejemplo.y"
               {(yyval.valor) = (yyvsp[0].valor);}
#line 1237 "ejemplo.tab.c"
    break;

  case 10: /* exp: AXUDA  */
#line 96 "ejemplo.y"
               {executar((yyvsp[0].cadea)); (yyval.valor) = NAN;}
#line 1243 "ejemplo.tab.c"
    break;

  case 11: /* exp: TABOA  */
#line 97 "ejemplo.y"
                {executar((yyvsp[0].cadea)); (yyval.valor) = NAN;}
#line 1249 "ejemplo.tab.c"
    break;

  case 12: /* exp: WORKSPACE  */
#line 98 "ejemplo.y"
                {executar((yyvsp[0].cadea)); (yyval.valor) = NAN;}
#line 1255 "ejemplo.tab.c"
    break;

  case 13: /* exp: ELIMINAR  */
#line 99 "ejemplo.y"
                {executar((yyvsp[0].cadea)); (yyval.valor) = NAN;}
#line 1261 "ejemplo.tab.c"
    break;
...
#line 1298 "ejemplo.tab.c"
    break;

  case 16: /* exp: '(' exp ')'  */
#line 127 "ejemplo.y"
                  {(yyval.valor) = (yyvsp[-1].valor);}
#line 1304 "ejemplo.tab.c"
    break;
...
#line 1751 "ejemplo.tab.c"
    break;


#line 1755 "ejemplo.tab.c"
